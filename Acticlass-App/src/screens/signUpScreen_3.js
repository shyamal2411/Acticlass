            ...
            <ScrollView style={{
                ...
                <View>
                    ...
                    <View style={{ paddingVertical: 16, paddingHorizontal: 40 }}>
                        <Text style={{ fontSize: 16, color: 'black', marginLeft: 10 }} >Password</Text>
                        <View style={styles.passwordContainer}>
                            <TextInput style={styles.password} secureTextEntry={!isPasswordVisible} placeholderTextColor={colors.placeholder}
                                placeholder="Enter your password" onChangeText={setPassword} />
                            <IonIcon name={isPasswordVisible ? 'eye-off' : 'eye'} size={24} color={colors.placeholder} onPress={() => setIsPasswordVisible(!isPasswordVisible)} />
                        </View>
                    </View>
                    <View style={{ paddingVertical: 16, paddingHorizontal: 40 }}>
                        <Text style={{ fontSize: 16, color: 'black', marginLeft: 10 }} >Confirm Password</Text>
                        <View style={styles.passwordContainer}>
                            <TextInput style={styles.password} secureTextEntry={!isCPasswordVisible} placeholderTextColor={colors.placeholder}
                                placeholder="Re-enter your password" onChangeText={setCPassword} />
                            <IonIcon name={isCPasswordVisible ? 'eye-off' : 'eye'} size={24} color={colors.placeholder} onPress={() => setIsCPasswordVisible(!isCPasswordVisible)} />
                        </View>
                    </View>
                    <View style={{ paddingVertical: 16, paddingHorizontal: 40 }}>
